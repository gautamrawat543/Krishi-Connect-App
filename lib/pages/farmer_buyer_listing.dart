            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  const Icon(Icons.filter_list_alt, color: AppColors.primaryGreenDark),
                ],
              ),
              const SizedBox(height: 20),
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      listingCard(width, widget.listing[index]),
                ),
              ),
            ],
          ),
        ...
        return Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Request Id: #${listing["requestId"]}', style: AppTextStyles.modalLabel),
                ...
                if (listing["createdAt"].toString() != "null")
                  Text(
                    DateFormat("d MMMM y, h:mm a").format(DateTime.parse(listing["createdAt"])),
