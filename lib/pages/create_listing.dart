...
class _CreateListingState extends State<CreateListing> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildLabel('Title'),
              buildTextField('eg: Bulk Purchase of Tomatoes', _titleController, TextInputType.text),
              _buildLabel('Description'),
              buildTextField('eg: Looking for high quality tomatoes in bulk', _descriptionController, TextInputType.text),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      buildTextField('eg: 500', _requiredQuantityController, TextInputType.number),
                    ],
                  ),
                ),
              ...
              buildTextField('eg: 1600', _maxPriceController, TextInputType.number),
              const SizedBox(height: 20),
              GestureDetector(
                onTap: _submitForm,
                child: Container(
  ...
  Widget buildDropdownField(List<String> items, String selectedValue, ValueChanged<String?> onChanged) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 12.0),
